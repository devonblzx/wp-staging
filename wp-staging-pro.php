 ...
 * Author URI: https://wpstaging.com
 * Version: {{ version }}
 * Text Domain: wpstg
    ...
    final class wpstaging {
        ...
        private function setup_constants() {
            ...
            if( !defined( 'WPSTG_SLUG' ) ) {
                define( 'WPSTG_SLUG', 'wp-staging-pro' );
            }
        }
        ...
        private function includes() {
            ...
            if( is_admin() || ( defined( 'WP_CLI' ) && WP_CLI ) ) {
                ...
                require_once WPSTG_PLUGIN_DIR . 'includes/admin/class-wpstg-file-sync.php';
                require_once WPSTG_PLUGIN_DIR . 'includes/admin/class-job-options.php';
                require_once WPSTG_PLUGIN_DIR . 'includes/admin/class-file.php';
                require_once WPSTG_PLUGIN_DIR . 'includes/admin/class-folders.php';
 ...
 */
function wp_staging_pro_loaded() {
    global $wpstg;
...
add_action( 'plugins_loaded', 'wp_staging_pro_loaded' );
